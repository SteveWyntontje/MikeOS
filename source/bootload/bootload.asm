...
; floppy for KERNEL.COM (the MikeOS kernel), loads it and executes it.
...
; STRINGS AND VARIABLES
	...
	kern_filename	db "KERNEL  COM"	; MikeOS kernel filename

	disk_error	db "Floppy error! Press any key...", 0
	file_not_found	db "KERNEL.COM not found!", 0
